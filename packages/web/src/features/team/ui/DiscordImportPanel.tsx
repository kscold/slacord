        ...
        <section className="rounded-[28px] border border-border-primary bg-bg-secondary p-5 sm:p-6">
            <div className="flex flex-wrap items-start justify-between gap-4">
                <div className="max-w-2xl">
                    ...
                    <p className="mt-2 text-sm leading-7 text-text-secondary">
                        Pawpong처럼 이미 운영 중인 Discord 서버가 있으면, 채널과 메시지 기록을 한 번에 옮길 수 있어요.
            ...
            <div className="mt-6 grid gap-3 md:grid-cols-2">
                <input
                    ...
                    className="rounded-2xl border border-border-primary bg-bg-primary px-4 py-3 text-sm text-white outline-none transition focus:border-brand-400"
                />
                <input
                    type="password"
                ...
                <textarea
                    ...
                    rows={3}
                    className="rounded-2xl border border-border-primary bg-bg-primary px-4 py-3 text-sm leading-6 text-white outline-none transition focus:border-brand-400 md:col-span-2"
                />
            </div>
            {importer.summary ? (
