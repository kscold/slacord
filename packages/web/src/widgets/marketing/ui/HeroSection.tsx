...
export function HeroSection() {
    return (
        <section className="relative overflow-hidden">
            ...
            {/* Content */}
            <div className="relative mx-auto grid max-w-6xl gap-10 px-6 py-24 lg:grid-cols-[1.1fr,0.9fr]">
                <div>
                ...
                <div className="rounded-[32px] border border-white/10 bg-[linear-gradient(180deg,#20170f_0%,#14100b_100%)] p-6 backdrop-blur-sm">
